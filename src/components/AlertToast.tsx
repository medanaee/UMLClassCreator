...
export const AlertToast: React.FC = () => {
  ...
  return (
    <div className={`fixed top-6 left-1/2 -translate-x-1/2 z-[99999] transition-all duration-300 ease-out font-sans ${visible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 -translate-y-4 scale-95 pointer-events-none'}`}>
      <div className={`flex items-center gap-3 px-4 py-3 rounded-xl border shadow-lg backdrop-blur-md min-w-[280px] max-w-[90vw] ${bgColors[alert?.type || 'info']}`}>
